...
describe("EthTokenBridge", function () {
    ...
    describe("receiveMessage", function () {
        it("Should correctly process received messages and transfer assets", async function () {
            ...
            await portal.receiveMessage(nonce1, sourceChain, sourceType, chiaSideBurnPuzzle, ethTokenBridge.target, message)
        ...
        it("Should fail if sender is not the portal", async function () {
            ...
            await expect(ethTokenBridge.connect(user).receiveMessage(nonce1, sourceChain, sourceType, chiaSideBurnPuzzle, message))
        ...
        it("Should fail if message source puzzle hash does not match", async function () {
            ...
            await expect(portal.receiveMessage(nonce1, sourceChain, sourceType, invalidPuzzle, ethTokenBridge.target, message))
