...
def generate_xch_key():
    ...
    click.echo(f"First address (testnet): {encode_puzzle_hash(first_puzzle_hash, 'txch')}")
    click.echo(f"First address (mainnet):  {encode_puzzle_hash(first_puzzle_hash, 'xch')}")
